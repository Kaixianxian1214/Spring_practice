...
public class TestBean {
    ...
    public void testBeanCollections(){
        ApplicationContext context =
                new ClassPathXmlApplicationContext("SpringDemo2/beanCollections.xml");
    ...
    public void testBeanCollections1(){
        ApplicationContext context =
                new ClassPathXmlApplicationContext("SpringDemo2/beanCollections1.xml");
    ...
    public void testBeanFactory(){
        ApplicationContext context =
                new ClassPathXmlApplicationContext("SpringDemo2/beanFactory.xml");
    ...
    public void testBean4(){
        ApplicationContext context =
                new ClassPathXmlApplicationContext("SpringDemo2/bean4.xml");
    ...
    public void testBean5(){
        ApplicationContext context =
                new ClassPathXmlApplicationContext("SpringDemo2/bean5.xml");
